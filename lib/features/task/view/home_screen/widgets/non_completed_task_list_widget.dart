...
class NonCompletedTaskListWidget extends StatelessWidget {
  const NonCompletedTaskListWidget({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        Selector<TaskViewModel, Stream<List<QueryDocumentSnapshot<TaskModel>>>>(
          selector: (_, viewModel) => viewModel.getAllNonCompleted(),
          builder: (_, value, __) {
